...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages at the [Mintlify API Components docs](https://mintlify.com/docs/api-playground/demo).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more at the [playground guides](https://mintlify.com/docs/api-playground/demo)
        </ResponseField>
      </Expandable>
    </ResponseField>
